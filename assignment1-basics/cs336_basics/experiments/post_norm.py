...
from cs336_basics.modules import (
    RoPE, MultiHeadSelfAttention, SwiGLU, Embedding, Linear, RMSNorm
)
...
DEFAULT_CONFIG = {
    ...
    'save_intervals': 1000,
    'log_intervals': 1,
    'save_ckp_path': './checkpoints/postnorm',
    'resume_ckp': None,
    'seed': 42, 
    ...
    'wandb_run_name': 'experiment2.postnorm',
    'no_wandb': False,
    'export_final': './out/model/model_postnorm.pt',   # 最终模型导出路径
}
